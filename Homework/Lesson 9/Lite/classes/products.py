...
class HouseholdChemicals(Product):
    """
    Класс, представляющий бытовую химию, дочерний по отношению к классу Product
    """
    def __init__(self, name, price, hazardClass):
        super().__init__(name, price)
        self.__hazardClass = hazardClass
        
    @property
    def hazardClass(self):
        return self.__hazardClass
        
    def get_details(self):
        return f"Бытовая химия {self.name}, класс опасности {self.__hazardClass}, цена {self.price} руб."